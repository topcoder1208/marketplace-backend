...
import { getAssociatedTokenAddress, getNftVaultPDA, getSellOrderPDA, getEscrowPDA, getBuyOfferPDA, getStorePDA } from './getPDAs'
...
export class Collection {
    ...
    async buyInstruction(
        ...
        console.log(marketplaceAccount.authority.toBase58(), "marketplaceAccount")
        let pay_type = 1;

        return await this.program.methods.buy(wanted_quantity, pay_type).accounts({
            buyer: buyer,
            seller: seller,
